...
object PlaneTest{
  ...
  val planeLeft = MyPlane(plane = new Plane(new Vector3D(1, 0, 0), new Vector3D(0, -1200, 0)), color = new Vector3D(0, 0, .5))
  val planeRight = MyPlane(plane = new Plane(new Vector3D(-1, 0, 0), new Vector3D(2400, 0, 0)), color = new Vector3D(.3, .2, .4))
  val planeCeil = MyPlane(plane = new Plane(new Vector3D(0, -1, 0), new Vector3D(0, -1200, 0)), color = new Vector3D(.4, .5, .1))
  ...
  val scene: Set[Object3D] = Set(triangle1, triangle, planeLeft, planeRight, planeCeil, floor, floor1, sphereRefraction, smallSphere, sphere1)
